...
P2moves1['1'].Time.Value = 10
P2moves1['2'].Time.Value = 15
P2moves1['3'].Time.Value = 15
P2moves1['4'].Time.Value = 15

P2moves2['1'].Time.Value = 10
P2moves2['2'].Time.Value = 60
P2moves2['3'].Time.Value = 20
...
local attackConP1 = game:GetService("UserInputService").InputBegan:Connect(function(key, gc)
    ...
    elseif key.KeyCode == Enum.KeyCode["One"] and not magic1cd and not char:FindFirstChild('UsingBone') and selectedMode == 1 and phase == 2 then
        spawn(function()
            activate(P2moves1['1'])
            magic1cd = true
            task.wait(P2moves1['1'].Time.Value + 0.2)
            magic1cd = false
        end)
        magic1()
        
    elseif key.KeyCode == Enum.KeyCode["Two"] and not magic2cd and not char:FindFirstChild('UsingBone') and selectedMode == 1 and phase == 2 then
        spawn(function()
            activate(P2moves1['2'])
            magic2cd = true
            task.wait(P2moves1['2'].Time.Value + 0.2)
            magic2cd = false
        end)
        magic2()
        
    elseif key.KeyCode == Enum.KeyCode["Three"] and not magic3cd and not char:FindFirstChild('UsingBone') and selectedMode == 1 and phase == 2 then
        spawn(function()
            activate(P2moves1['3'])
            magic3cd = true
            task.wait(P2moves1['2'].Time.Value + 0.2)
    ...
    elseif key.KeyCode == Enum.KeyCode["Four"] and not magic4cd and not char:FindFirstChild('UsingBone') and selectedMode == 1 and phase == 2 then
        spawn(function()
            activate(P2moves1['4'])
            magic4cd = true
            task.wait(P2moves1['4'].Time.Value + 0.2)
            magic4cd = false
        end)
        magic4()
        
    elseif key.KeyCode == Enum.KeyCode["One"] and not sword1P2cd and not char:FindFirstChild('UsingBone') and selectedMode == 2 and Phase == 2 then
        spawn(function()
            activate(P2moves2['1'])
            sword1P2cd = true
            task.wait(P2moves2['1'].Time.Value + 0.2)
            sword1P2cd = false
        end)
        sword1P2()
    end
